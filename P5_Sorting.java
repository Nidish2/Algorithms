...
//		  System.arraycopy(arr, si, merged, 0, array.length);
	}
	...
	private int partition(int[] arr, int low, int high) {
		...
		// int temp = arr[i + 1];
		// arr[i + 1] = arr[high]; //which is pivotElem
		// arr[high] = temp;
		swap(arr, i + 1, high);
	...
	public static void main(String[] args) {
		...
		// happens when the pivot is always the smallest or largest in array (ie. sorted
		// arr (A or D))
